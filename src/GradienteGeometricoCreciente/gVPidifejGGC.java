 ...
 * @author Adrian AC
 */
public class gVPidifejGGC extends javax.swing.JInternalFrame {
   int nDecimal=nDecimales.num();
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(resultado, javax.swing.GroupLayout.PREFERRED_SIZE, 417, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void txtJKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtJKeyReleased
        ...
        double r = redondearDecimales.redondearDecimales(Gradiente_Geometrico_Creciente.vPresenteD(numA,numI,numJ,numPer),nDecimal);
