 ...
 * @author Adrian AC
 */
public class iNA extends javax.swing.JInternalFrame {
   int nDecimal=nDecimales.num();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle(" Efectiva Periodica a Nominal Anual");
        setToolTipText(" Efectiva Periodica a Nominal Anual (Conversion de Tasas)");
        ...
        jLabel1.setText("Tasa Periodica");
        ...
        jliP.setBackground(new java.awt.Color(0, 0, 0));
        jliP.setFont(new java.awt.Font("Dialog", 3, 18)); // NOI18N
        jliP.setText("iPer");

        periodos.setBackground(new java.awt.Color(0, 0, 0));
        periodos.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        periodos.setText("n");
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jliP, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGap(23, 23, 23)
                .addComponent(resultado, javax.swing.GroupLayout.PREFERRED_SIZE, 396, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtiPKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtiPKeyReleased
        ...
        jliP.setText(iP);
        double numiP = Double.parseDouble(txtiP.getText());
        double numPer = Double.parseDouble(txtnPer.getText());
        double r = redondearDecimales.redondearDecimales(ConversionTasas.EfectivaPeriodica_NominalAnual(numPer, numiP),nDecimal);
