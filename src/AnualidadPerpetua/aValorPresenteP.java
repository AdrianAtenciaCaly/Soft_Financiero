 ...
 */
package AnualidadPerpetua;


import AnualidadVencida.*;
import formulas.Anualidad_Perpetua;
 ...
 * @author Adrian AC
 */
public class aValorPresenteP extends javax.swing.JInternalFrame {
       int nDecimal=nDecimales.num();
    public aValorPresenteP() {
        initComponents();  
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Valor Presente Perpetuo");
        setToolTipText("Valor Presente Perpetuo (Anualidades)");
    ...
    private void txtVFKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtVFKeyReleased
      ...
      A.setText(vf);
       ...
       double r = redondearDecimales.redondearDecimales(Anualidad_Perpetua.vPresente(a, numI),nDecimal);        
