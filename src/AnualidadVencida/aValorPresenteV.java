 ...
 * @author Adrian AC
 */
public class aValorPresenteV extends javax.swing.JInternalFrame {
        int nDecimal=nDecimales.num();
    public aValorPresenteV() {
        initComponents();  
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Valor Presente Vencido ");
        setToolTipText("Valor Presente Vencido (Anualidades)");
    ...
    private void txtAKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtAKeyReleased
      ...
      A.setText(aa);
       ...
       double r = redondearDecimales.redondearDecimales(Anualidades_Vencidas.vPresente(numA, numI,numPer),nDecimal);        
