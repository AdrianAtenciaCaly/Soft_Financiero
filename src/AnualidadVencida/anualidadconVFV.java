 ...
 * @author Adrian AC
 */
public class anualidadconVFV extends javax.swing.JInternalFrame {
    int nDecimal=nDecimales.num();
    public anualidadconVFV() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(resultado, javax.swing.GroupLayout.PREFERRED_SIZE, 411, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtVFKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtVFKeyReleased
        ...
        double r = redondearDecimales.redondearDecimales(Anualidades_Vencidas.anualidadVF(numVF, numI, numPer), nDecimal);
