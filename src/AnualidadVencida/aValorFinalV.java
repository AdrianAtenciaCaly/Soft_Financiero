 ...
 * @author Adrian AC
 */
public class aValorFinalV extends javax.swing.JInternalFrame {
   int nDecimal=nDecimales.num();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Valor Final Vencido");
        setToolTipText("Valor Final Vencido (Anualidades)");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(resultado, javax.swing.GroupLayout.PREFERRED_SIZE, 451, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtAKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtAKeyReleased
        ...
        double r = redondearDecimales.redondearDecimales(Anualidades_Vencidas.vFinal(a, numPer, numI), nDecimal);
